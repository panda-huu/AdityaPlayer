...
async def _get_target_and_reason(msg: Message):
    ...
    elif msg.command and len(msg.command) > 1:
        try:
...
@bot.on_message(cdx("mute") & filters.group)
...
@bot.on_message(cdx("unmute") & filters.group)
...
@bot.on_message(cdx("ban") & filters.group)
...
@bot.on_message(cdx("unban") & filters.group)
...
@bot.on_message(cdx("kick") & filters.group)
